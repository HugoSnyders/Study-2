  ...
  class HtmlSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      html +=
        ...
        '" step="' +
        trial.step +
        '" style="width: 100%;" id="jspsych-html-slider-response-response" oninput="document.getElementById(&quot;output&quot;).value = this.value"></input>';
      if (trial.slider_number) {
        html +=
          '<div style="vertical-align: top; width: 110%; text-align: right; position: relative; top: -40px; left: 15px; z-index: -1;"><output id = "output">0</output>%</div>';
      }
      ...
      for (var j = 0; j < trial.labels.length; j++) {
        ...
        html +=
          '<div style="border: 1px solid transparent; display: inline-block; position: absolute; top: 30px;' +
          "left:calc(" +
          percent_of_range +
          "% - (" +
          label_width_perc +
