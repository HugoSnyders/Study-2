var headline_stimuli = [
  ...
  {
    text: "99.9% of climate studies agree: burning fossil fuels drives climate change",
    topic: "Climate Change",
    info: true,
    length: 11,
    code: "AT3",
  ...
  {
    text: "Rising global temperatures caused by changes in solar activity, not fossil fuels",
    topic: "Climate Change",
    info: false,
    length: 12,
    code: "AF6",
  ...
  {
    text: "COVID-19 vaccination increases immunity significantly",
    topic: "Vaccination",
    info: true,
    length: 5,
    code: "BT6",
  ...
  {
    text: "Reported death rates higher among people vaccinated against COVID-19",
    topic: "Vaccination",
    info: false,
    length: 9,
    code: "BF7",
  ...
  {
    text: "New GMO soy beans have potential to enhance global food security",
    topic: "GMO",
    info: true,
    length: 11,
    code: "CT1",
  ...
  {
    text: "Planting GMO crops risks harm to ecosystems worldwide",
    topic: "GMO",
    info: false,
    length: 8,
    code: "CF4",
  ...
  {
    text: "No public health risks from 5G with exposure within international guidelines",
    topic: "5G",
    info: true,
    length: 11,
    code: "DT5",
  ...
  {
    text: "Potential neurological damage found following 5G exposure",
    topic: "5G",
    info: false,
    length: 7,
    code: "DF7",
  ...
  {
    text: "No evidence of systemic voter fraud in 2020 election",
    topic: "Voter Fraud",
    info: true,
    length: 9,
    code: "ET1",
  ...
  {
    text: "Reports of missing vote bags prove vote tampering during 2020 election",
    topic: "Voter Fraud",
    info: false,
    length: 11,
    code: "EF4",
